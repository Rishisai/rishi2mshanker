...
```{r}
ridership.ts <- ts(Sept11Travel$`Air RPM (000s)`, 
    start = c(1990, 1), end = c(2001, 3), freq = 12)
plot(ridership.ts, xlab = "Time", ylab = "Ridership (in 000s)")
```
...
```{r}
ridership.ts <- ts(Sept11Travel$`Rail PM`, 
    start = c(1990, 1), end = c(2001, 3), freq = 12)
plot(ridership.ts, xlab = "Time", ylab = "Ridership (in 000s)")
```
```{r}
...
#vmt................
```{r}
ridership.ts <- ts(Sept11Travel$`VMT (billions)`, 
    start = c(1990, 1), end = c(2001, 3), freq = 12)
plot(ridership.ts, xlab = "Time", ylab = "Ridership (in 000s)")
```
```{r}
